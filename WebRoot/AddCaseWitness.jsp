 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addcasewitness" action="./AddCaseWitnessAction" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">CASE WITNESS DETAILS</font></center></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> </td></tr>
     ...
     <tr>
      ...
      <tr>
      <td>Witness First Name</td>
      <td><input type="text" name="witnessfstname" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Witness Middle Name</td>
      <td><input type="text" name="witnessmidname" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Witness Last Name</td>
      <td><input type="text" name="witnesslstname" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Witness Type </td>
      <td><select name="witnesstype" >
      ...
      <tr>
      <td>Witness Sequence Number </td>
      <td><input type="text" name="witnessseqno" value=""/>
      </td>
      </tr>
      ...
      <tr>
      <td>Address</td>
      <td><textarea rows=4 columns=4 name="address" value=""></textarea>
    ...
    <SELECT name=cday size=1 > 
      ...
      <tr>
      <td>Witness Record Statement</td>
      <td><textarea type=text rows=5 columns=5 name="witnessrecordstmt" value=""></textarea>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addcasewitness");
    
  frmvalidator.addValidation("caseid","req","dontselect=0");
  frmvalidator.addValidation("witnessfstname","req","Please Enter Witness First Name");
  frmvalidator.addValidation("witnessmidname","req","Please Enter Witness Middle Name");  
  frmvalidator.addValidation("witnesslstname","req","Please Enter Witness Last Name");
  ...
  frmvalidator.addValidation("address","req","Please Enter Witness Address");
  frmvalidator.addValidation("dateofbirth","req","Please Enter Date Of Birth");
