...
function inDate(){
  ...
  var date=new Date();
  document.addcaseevidence.evidenceregdate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
window.location.href='http://localhost:8081//ChekUserAction?username='+username;
 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addcaseevidence" action="./AddCaseEvidenceAction" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">CASE EVIDENCE DETAILS</font></center></th>
      <tr rowspan="5"></tr>
       <tr></tr><tr></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
     ...
     <tr>
      ...
      <% CoreHash ch=new CaseRegistrationDAO().getCaseID();
      ...
      <tr>
      <td>Evidence Registration Date</td>
      <td><input type="text" name="evidenceregdate" onfocus="inDate()" value=""/>
      </td>
      </tr>
      ...
      <td><select name="evidencetypename" >
      <option value="">-Select-</option>
       <% CoreHash ch2=new EvidenceTypeDAO().getEvidenceTypeNames();
         Enumeration em2=ch2.elements();
          EvidenceTypeModel evidencetypemodel=null;
         while(em2.hasMoreElements()){
             evidencetypemodel=(EvidenceTypeModel)em2.nextElement();
         %>
      ...
      <tr>
      <td>Evidence Type Description</td>
      ...
      <td><input type=file name="evidenceimage" value=""/>
      ...
      <td><input type=file name="evidencevedio" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Evidence Audio</td>
      <td><input type=file name="evidenceaudio" value=""/>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addcaseevidence");
    
  frmvalidator.addValidation("caseid","req","dontselect=0");
  frmvalidator.addValidation("evidenceregdate","req","Please Enter Evidence Registration Date");
