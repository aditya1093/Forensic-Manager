 ...
 <tr>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <form name="seesection" action="./UpdateSectionAction" method="post" onSubmit="return validate()">     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">SECTION DETAILS</font></center></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
      ...
      SectionModel  sectionmodel=null;
       sectionmodel=new SectionDAO().getSectionDetails(sectionid);
    ...
    <td>Section ID </td>
    <td><input type="text"  name="sectionid"  value="<%=sectionmodel.getSectionid()%>" readonly /></td>
     </tr>
     
      <tr>    
    <td>Actual Section No</td>
    <td><input type="text"  name="actualsecno"  value="<%=sectionmodel.getActualsectionno()%>" readonly /></td>
     </tr>
     
     <tr>    
    <td>Section Description</td>
    <td><input type="text"  name="sectiondesc"  value="<%=sectionmodel.getSectiondesc()%>" /></td>
     </tr>
    
    
     <tr>
     <input type="hidden" name="lawtypeid" value="<%=sectionmodel.getTypeoflawid()%>" readonly />
    <td>Law Type Name</td>
    <td><input type="text" name="lawtypename" value="<%=sectionmodel.getLawtypename()%>"/></td>
    </tr>
    
<tr>
    <td>Section Commence Date</td>
    <td><input type="text" name="sectioncommdate" readonly value="<%=sectionmodel.getSectioncommendate()%>"/></td>
    </tr>
    
    <tr>
    <td>Section Active State</td>
    <td><input type="text" name="sectionactstate" value="<%=sectionmodel.getSectionactivestate()%>"/></td>
    </tr>
    
    
    <tr>
    <td>Section/Sub Section Bit</td>
    <td><input type="text" name="sectionbit"   value="<%=sectionmodel.getSectionandsubsecbit()%>"/></td>
   </tr>
