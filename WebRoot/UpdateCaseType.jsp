...
<form name="updatecasetype" action="./" method="post" onSubmit="return validate()" >     
...
<%--      </tr>--%>
      ...
      <td><input type="text" name="casetypedesc" value=""/>
      </td>
      </tr>
...
var frmvalidator  = new Validator("updatecasetype");
