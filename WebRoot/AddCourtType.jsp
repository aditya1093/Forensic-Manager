 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addcourttype" action="./AddCourtTypeAction" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
      ...
      <td><input type="text" name="courttypename" value=""/>
      </td>
      </tr>
      ...
      <td><input type="text" name="courttypeabbr" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Court Type Description</td>
      <td><textarea rows=4 column=4 name="courttypedesc" value=""></textarea>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addcourttype");
  frmvalidator.addValidation("courttypename","req","Please Enter CourtType Name");
  
  frmvalidator.addValidation("courttypeabbr","req","Please Enter CourtType Abbreviation");
  frmvalidator.addValidation("courttypedesc","req","Please Enter CourtType Description");
