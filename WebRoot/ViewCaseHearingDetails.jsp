...
<%@page import="com.dts.project.model.CaseHearingModel"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table width="103%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
  ...
  <form name="viewcasehearing" action="ViewCaseHearingDetails.jsp" method="post" onSubmit="return validate()" >  
           
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">CASE HEARING DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
...
String vediostorepath1=getServletContext().getRealPath("/Video");
     ...
     CaseRegistrationModel caseregmodel=null;
      ...
      <td colspan="2"><center><input type="submit" name="submit" value="Search"/>
        ...
        <%if(request.getParameter("submit")!=null){ %>    
          ...
          <form  name="viewcasehearingdetails" action="" method=""> 
 ...
 //lawyermodel=new LawyerDAO().getLawyersProfile(loginname);
       ...
       CoreHash ch=new CaseHearingDAO().getAllCaseHearingDetails(caseid);
    ...
    <td>Case Hearing ID </td>
     ...
     <td>Any Special Instruction</td>      
         ...
         <% while(em.hasMoreElements()){
             casehearingmodel=(CaseHearingModel)em.nextElement();
             
             %>
        <tr> 
        
   <td  value="<%=casehearingmodel.getCasehearingid()%>"><%=casehearingmodel.getCasehearingid() %> </td>

         <td><%=casehearingmodel.getCaseid()%></td> 
         <td><%=casehearingmodel.getHearingdate()%></td>
         <td><%=casehearingmodel.getHearingresult()%></td> 
         <td><%=casehearingmodel.getNexthearingdate()%></td>
         <td><%=casehearingmodel.getAnyspecialinstruction()%></td> 
