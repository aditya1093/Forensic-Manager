...
<%
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		...
		<h2> Sample Video File  is Playing</h2>
      <h4>Video File Name is=<%=request.getParameter("sampleVideo") %></h4>
...
classid="CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95"
 ...
 <%String samplevideo=request.getParameter("sampleVideo");
 System.out.println("samplevideofile"+samplevideo); %>
 <PARAM NAME="Filename" VALUE="./Video/<%=samplevideo%>"/>
 <PARAM NAME="ShowStatusBar" VALUE="-1"/>
	...
	<tr>
    <td height="25" colspan="40" bgcolor="#0D4961" align="center"><font color="#ffffff"><span class="style1">&copy;All rights reserved</span></font></td>
  </tr>
</table>
</body>
</html>