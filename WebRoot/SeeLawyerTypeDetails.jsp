 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="seelawtype" action="./UpdateLawyerTypeAction" method="post" onSubmit="return validate()">     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">LAWYER TYPE DETAILS</font></center></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                int lawyertypeid=Integer.parseInt(request.getParameter("lawyertypeid"));
                
                String loginname=(String)session.getAttribute("user"); 

       try{
      LawyerTypeModel  lawyertypemodel=null;
       lawyertypemodel=new LawyerTypeDAO().getLawyerTypeDetails(lawyertypeid);
     ...
     <input type="hidden" name="lawyertypeid" value="<%=lawyertypemodel.getLawyertypeid()%>" readonly />
    <td>Lawyer Type Name </td>
    <td><input type="text"  name="lawyertypename"  value="<%=lawyertypemodel.getLawyertypename()%>" readonly /></td>
     </tr>
     ...
     <tr>    
    <td> Abbreviation</td>
    <td><input type="text"  name="abbr"  value="<%=lawyertypemodel.getLawyertypeabbr()%>" /></td>
     </tr>
    
    
     <tr>
     <td>Description</td>
    <td><input type="text" name="desc" value="<%=lawyertypemodel.getLawyertypedesc()%>"/></td>
    </tr>
