...
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">LAW TYPE DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       try{
       CoreHash ch=new LawTypeDAO().getAllLawTypeDetails();
         ...
         LawTypeModel  lawtypemodel=null;
          ...
          report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>LAW TYPE DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr>    <tr><td>Law Type Name</td><td> Abbreviation</td><td>Description</td></tr>  ";    
    ...
    <tr>         
     ...
     <td>Description</td>
         ...
         <% while(em.hasMoreElements()){
             lawtypemodel=(LawTypeModel)em.nextElement();
             
          report+="<tr><td  value="+lawtypemodel.getLawtypeid()+">"+lawtypemodel.getLawtypename()+"</td>";
          report+="<td>"+lawtypemodel.getLawtypeabbr()+"</td>";
          report+="<td>"+lawtypemodel.getDesc()+"</td></tr>";   
   ...
   <td><a href="SeeLawTypeDetails.jsp?lawtypeid=<%=lawtypemodel.getLawtypeid()%>"><%=lawtypemodel.getLawtypename() %> </a></td>
         <td><%=lawtypemodel.getLawtypeabbr()%></td>
         <td><%=lawtypemodel.getDesc()%></td> 
