 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addlawyertype" action="./AddLawyerTypeAction" method="post" onSubmit="return validate()" >     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> </td></tr>
      ...
      <td><textarea rows=4 cloumns=4 name="lawyertypedesc" value=""></textarea>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addlawyertype");
