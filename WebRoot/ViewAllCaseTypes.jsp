 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="viewcasetype" action="" method="post" onSubmit="return validate()" >  
...
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">CASE TYPE DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       try{
       CoreHash ch=new CaseTypeDAO().getAllCaseTypeDetails();
      ...
      report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>CASE TYPE DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr><tr><td>Case Type Name</td><td> Abbreviation</td><td>Description</td></tr>";    
    ...
    <tr>         
     ...
     <td>Description</td>
         ...
         <% while(em.hasMoreElements()){
             ...
             report+="<tr><td value="+casetypemodel.getCasetypeid()+">"+casetypemodel.getCasetypename()+"</td>";
        report+="<td>"+casetypemodel.getCasetypeabbr()+"</td>";
         report+="<td>"+casetypemodel.getCasetypedesc()+"</td></tr>";
         
         session.setAttribute("Report",report); 
         %>
        <tr> 
         <td><a href="SeeCaseTypeDetails.jsp?casetypeid=<%=casetypemodel.getCasetypeid()%>"><%=casetypemodel.getCasetypename() %> </a></td>
        <td><%=casetypemodel.getCasetypeabbr()%></td>
         <td><%=casetypemodel.getCasetypedesc()%></td> 
          </tr>
        <%             
