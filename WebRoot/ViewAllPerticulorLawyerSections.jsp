 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="viewlawyersection" action="" method="post" onSubmit="return validate()" >   
...
String vediostorepath1=getServletContext().getRealPath("/Video");
        ...
        String lawtype=lawyermodel.getLawtypename();
      
       CoreHash ch=new SectionDAO().getSectionsOfPerticularLawTypes(lawtype.trim());
   ...
   <td><%=sectionmodel.getSectionid()%> </td>
