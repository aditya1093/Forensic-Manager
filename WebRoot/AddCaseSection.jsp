 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addcasesection" action="./" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">CASE SECTION DETAILS</font></center></th>
      <tr rowspan="5"></tr>
      ...
      <tr>
      <td>Case Name</td>
      <td><input type="text" name="casename" value=""/>
      </td>
      </tr>
      ...
      <tr>
      <td>Section ID</td>
      <td><select name="sectionid" value="">
      </select>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addcasesection");
  frmvalidator.addValidation("casename","dontselect=0");  
  frmvalidator.addValidation("sectionid","req","Please Enter Section ID");
