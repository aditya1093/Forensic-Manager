...
<%@page import="com.dts.project.dao.EvidenceTypeDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="seeevidencetype" action="./UpdateEvidenceTypeAction" method="post" onSubmit="return validate()">     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">EVIDENCE TYPE DETAILS</font></center></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                int evidencetypeid=Integer.parseInt(request.getParameter("evidencetypeid"));
                
                String loginname=(String)session.getAttribute("user"); 

       try{
      EvidenceTypeModel  evidencetypemodel=null;
       evidencetypemodel=new EvidenceTypeDAO().getEvidenceTypeDetails(evidencetypeid);
     ...
     <input type="hidden" name="evidencetypeid" value="<%=evidencetypemodel.getEvidencetypeid()%>" readonly />
    <td>Evidence Type Name </td>
    <td><input type="text"  name="evidencetypename"  value="<%=evidencetypemodel.getEvidencetypename()%>" readonly /></td>
     </tr>
     ...
     <tr>    
    <td> Abbreviation</td>
    <td><input type="text"  name="abbr"  value="<%=evidencetypemodel.getEvidencetypeabbr()%>" /></td>
     </tr>
    
    
     <tr>
     <td>Description</td>
    <td><input type="text" name="desc" value="<%=evidencetypemodel.getEvidencetypedesc()%>"/></td>
    </tr>
