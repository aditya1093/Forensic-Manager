...
function inDate(){
  ...
  var date=new Date();
  document.addsection.sectioncommencedate.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addsection" action="./AddSectionAction" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> </td></tr>
      ...
      <td><input type="text" name="sectioncommencedate" onfocus="inDate()"  value=""/>
      </td>
      </tr>
      
       <tr>
      <td>Section Active State</td>
      <td><select name="sectionactivestate" >
      <option value="">-Select-</option>
...
var frmvalidator  = new Validator("addsection");
