...
<%@page import="com.dts.project.model.CourtTypeModel"%>
<%@page import="com.dts.project.dao.LawyerTypeDAO"%>
<%@page import="com.dts.project.model.LawyerTypeModel"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">LAWYER TYPE DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       try{
       CoreHash ch=new LawyerTypeDAO().getAllLawyerTypeDetails();
      ...
      report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>LAWYER TYPE DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr> <tr><td>Lawyer Type Name</td><td> Abbreviation</td><td>Description</td></tr>";     
                
         %> 
         
    <tr>         
     <td>Lawyer Type Name</td>
     <td> Abbreviation</td>
     <td>Description</td>
    </tr>   
         <% while(em.hasMoreElements()){
             lawyertypemodel=(LawyerTypeModel)em.nextElement();
             
         report+="<tr><td value="+lawyertypemodel.getLawyertypeid()+">"+lawyertypemodel.getLawyertypename()+"</td>";
          report+="<td>"+lawyertypemodel.getLawyertypeabbr()+"</td>";
         report+="<td>"+lawyertypemodel.getLawyertypedesc()+"</td></tr>";
   ...
   <td><a href="SeeLawyerTypeDetails.jsp?lawyertypeid=<%=lawyertypemodel.getLawyertypeid()%>"><%=lawyertypemodel.getLawyertypename() %> </a></td>
     <td><%=lawyertypemodel.getLawyertypeabbr()%></td>
         <td><%=lawyertypemodel.getLawyertypedesc()%></td> 
