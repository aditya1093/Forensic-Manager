 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="addcasetype" action="./CaseTypeAction" method="post" onSubmit="return validate()" >     
<table width=430 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> </td></tr>
      ...
      <td><input type="text" name="casetypename" value=""/>
      </td>
      </tr>
      
      
      <tr>
      <td>Case Type Abbreviation</td>
      <td><input type="text" name="casetypeabbr" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>Case Type Description</td>
      <td><textarea rows=4 columns=4 name="casetypedesc" value=""></textarea>
      </td>
      </tr>
...
var frmvalidator  = new Validator("addcasetype");
  frmvalidator.addValidation("casetypename","req","Please Enter Case Type Name");
  
  frmvalidator.addValidation("casetypeabbr","req","Please Enter Case Type Abbreviation");
  frmvalidator.addValidation("casetypedesc","req","Please Enter Case Type Description");
