...
<%@page import="com.dts.project.dao.CaseWitnessDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table width="103%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
  ...
  <form name="viewcasewitness" action="ViewCaseWitnessDetails.jsp" method="post" onSubmit="return validate()" >  
           
<table align="center" WIDTH="700" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">CASE WITNESS DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
...
String vediostorepath1=getServletContext().getRealPath("/Video");
     ...
     CaseRegistrationModel caseregmodel=null;
      ...
      <td colspan="2"><center><input type="submit" name="submit" value="Search"/>
        ...
        <%if(request.getParameter("submit")!=null){ %>    
          ...
          <form  name="viewcasewitnessdetails" action="" method=""> 
          
           <table align="center" WIDTH="800" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">CASE WITNESS DETAILS</font></center></b></th>
      <tr rowspan="5"></tr> 
      <%
       ...
       CoreHash ch=new CaseWitnessDAO().getAllCaseWitnessDetails(caseid);
    ...
    <tr>         
    <td>Case Witness ID </td>
     <td>Case ID</td>
     <td>Witness Fst Name</td>
     <td>Witness Mid Name</td>
      <td>Witness Lst Name</td>
     <td>Witness  Type</td>
     <td>Witness  Seq No</td> 
     <td>Address</td>
     <td>DOB</td>  
     <td>Record Statement</td>       
      </tr>   
         <% while(em.hasMoreElements()){
             casewitnessmodel=(CaseWitnessModel)em.nextElement();
             
             %>
        <tr> 
        
   <td><%=casewitnessmodel.getCasewitnessid()%> </td>

         <td><%=casewitnessmodel.getCaseid()%></td> 
         <td><%=casewitnessmodel.getWitnessfstname()%></td>
         <td ><%=casewitnessmodel.getWitnessmidname() %></td>
         <td><%=casewitnessmodel.getWitnesslstname()%></td> 
         <td><%=casewitnessmodel.getWitnesstype()%></td>
         <td><%=casewitnessmodel.getWitnessseqno()%></td>
         <td><%=casewitnessmodel.getAddress()%></td>
         <td><%=casewitnessmodel.getDob()%></td>
         <td><%=casewitnessmodel.getWitnessrecordedstatement()%></td>
