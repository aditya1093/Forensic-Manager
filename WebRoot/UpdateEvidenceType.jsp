    ...
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <td width="78%" align="left" valign="top"><br />
         <form name="updateevidencetype" action="./" method="post" onSubmit="return validate()" >     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="430" border="0" bordercolor="black" bgcolor="#F4F5F7">
...
<%--      <tr>--%>
<%--      <td>EvidenceType Name</td>--%>
<%--      <td><input type="text" name="evidencetypename" value=""/>--%>
<%--      </td>--%>
<%--      </tr>--%>
      
      
      <tr>
      <td>EvidenceType Abbreviation</td>
      <td><input type="text" name="evidencetypeabbr" value=""/>
      </td>
      </tr>
      
      <tr>
      <td>EvidenceType Description</td>
      <td><input type="text" name="evidencetypedesc" value=""/>
      </td>
      </tr>
...
var frmvalidator  = new Validator("updateevidencetype");
  //frmvalidator.addValidation("evidencetypename","req","Please Enter Evidence Type Name");
  
  frmvalidator.addValidation("evidencetypeabbr","req","Please Enter Evidence Type Abbreviation");
  frmvalidator.addValidation("evidencetypedesc","req","Please Enter Evidence Type Description");
