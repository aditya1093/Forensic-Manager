 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="seemember" action="./UpdateCaseMemberAction" method="post" onSubmit="return validate()">     
<table width=700 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="700" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                int casememberid=Integer.parseInt(request.getParameter("casememberid"));
                
                String loginname=(String)session.getAttribute("user"); 

       try{
      CaseMemberModel  casemembermodel=null;
       casemembermodel=new CaseMemberDAO().getCaseMemberDetails(casememberid);
        ...
        <tr>
        <input type="hidden" name="memberid" value="<%=casemembermodel.getCasememberid()%>" readonly />
    <td>Member Name </td>
    <td><input type="text"  name="membername"  value="<%=casemembermodel.getCasememberfstname()%>" readonly /></td>
     </tr>
     
      <tr>    
    <td>Case ID</td>
    <td><input type="text"  name="caseid"  value="<%=casemembermodel.getCaseid()%>" readonly /></td>
     </tr>
     
     <tr>    
    <td>Member Type</td>
    <td><input type="text"  name="membertype"  value="<%=casemembermodel.getMembertype()%>" /></td>
     </tr>
    
    
     <tr>
    <td>Sequence No</td>
    <td><input type="text" name="sdequenceno" value="<%=casemembermodel.getSequenceno()%>"/></td>
    </tr>
    
    <tr>
      <td>Father Name</td>
      <td><input type="text" name="fathername" readonly value="<%=casemembermodel.getCasememberftherfstname()%>"/></td>
    </tr>
    
    <tr>
    <td>Address</td>
    <td><input type="text" name="address"  value="<%=casemembermodel.getCasememberaddress()%>"/></td>
    </tr>
    
    <tr>
    <td>DOB</td>
    <td><input type="text" name="dob" readonly  value="<%=casemembermodel.getDob()%>"/></td>
    </tr>
