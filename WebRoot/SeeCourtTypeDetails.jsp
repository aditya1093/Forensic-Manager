...
<%@page import="com.dts.project.dao.CourtTypeDAO"%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="seecourttype" action="./UpdateCourtTypeAction" method="post" onSubmit="return validate()">     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="2" bgcolor="black"><center><b><font color="white">COURT TYPE DETAILS</font></center></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
      ...
      CourtTypeModel  courttypemodel=null;
       courttypemodel=new CourtTypeDAO().getCourtTypeDetails(courttypeid);
     ...
     <input type="hidden" name="courttypeid" value="<%=courttypemodel.getCourttypeid()%>" readonly />
    <td>Court Type Name </td>
    <td><input type="text"  name="courttypename"  value="<%=courttypemodel.getCourttypename()%>" readonly /></td>
     </tr>
     
     
     
     <tr>    
    <td>Court Type Abbreviation</td>
    <td><input type="text"  name="abbr"  value="<%=courttypemodel.getCourttypeabbr()%>" /></td>
     </tr>
    
    
     <tr>
     <td>Description</td>
    <td><input type="text" name="desc" value="<%=courttypemodel.getCourttypedesc()%>"/></td>
    </tr>
