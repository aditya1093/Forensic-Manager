...
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">COURTS TYPE DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       try{
       CoreHash ch=new CourtTypeDAO().getAllCourtsTypeDetails();
      ...
      report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>COURT TYPE DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr><tr><td>Court Type Name</td><td>Court Abbreviation</td><td>Description</td></tr>";    
    ...
    <tr>         
     ...
     <td>Court Abbreviation</td>
     <td>Description</td>
    </tr>   
         <% while(em.hasMoreElements()){
             courttypemodel=(CourtTypeModel)em.nextElement();
             
           report+="<tr><td value="+courttypemodel.getCourttypeid()+">"+courttypemodel.getCourttypename()+"</td>";

        
         report+="<td>"+courttypemodel.getCourttypeabbr()+"</td>";
         report+="<td>"+courttypemodel.getCourttypedesc()+"</td></tr>";  
  session.setAttribute("Report",report); 
             
         %>
        <tr> 
        
   <td><a href="SeeCourtTypeDetails.jsp?courttypeid=<%=courttypemodel.getCourttypeid()%>"><%=courttypemodel.getCourttypename() %> </a></td>

        
         <td><%=courttypemodel.getCourttypeabbr()%></td>
         <td><%=courttypemodel.getCourttypedesc()%></td> 
