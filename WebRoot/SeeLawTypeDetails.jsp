 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="seelawtype" action="./UpdateLawTypeAction" method="post" onSubmit="return validate()">     
<table width=600 align=center border=2 bordercolor=red><tr><td><table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
                ...
                <%
                int lawtypeid=Integer.parseInt(request.getParameter("lawtypeid"));
                
                String loginname=(String)session.getAttribute("user"); 

       try{
      LawTypeModel  lawtypemodel=null;
       lawtypemodel=new LawTypeDAO().getLawTypeDetails(lawtypeid);
     ...
     <input type="hidden" name="lawtypeid" value="<%=lawtypemodel.getLawtypeid()%>" readonly />
    <td>Law Type Name </td>
    <td><input type="text"  name="lawtypename"  value="<%=lawtypemodel.getLawtypename()%>" readonly /></td>
     </tr>
     ...
     <tr>    
    <td> Abbreviation</td>
    <td><input type="text"  name="abbr"  value="<%=lawtypemodel.getLawtypeabbr()%>" /></td>
     </tr>
    
    
     <tr>
     <td>Description</td>
    <td><input type="text" name="desc" value="<%=lawtypemodel.getDesc()%>"/></td>
    </tr>
