...
<%@page import="com.dts.project.model.LawyerTypeModel"%>
...
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
      <th colspan="10" bgcolor="black"><b><center><font color="white">EVIDENCE TYPE DETAILS</font></center></b></th>
      <tr rowspan="5"></tr>
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
       ...
       try{
       CoreHash ch=new EvidenceTypeDAO().getAllEvidenceDetails();
      ...
      report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>EVIDENCE TYPE DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr><tr><td>Evidence Type Name</td><td>Evidence Abbreviation</td><td>Description</td></tr> ";    
    ...
    <tr>         
     ...
     <td>Evidence Abbreviation</td>
     <td>Description</td>
    </tr>   
         <% while(em.hasMoreElements()){
             evidencetypemodel=(EvidenceTypeModel)em.nextElement();
             
             report+="<tr><td value="+evidencetypemodel.getEvidencetypeid()+">"+evidencetypemodel.getEvidencetypename()+"</td>";
     
         report+="<td>"+evidencetypemodel.getEvidencetypeabbr()+"</td>";
         report+="<td>"+evidencetypemodel.getEvidencetypedesc()+"</td></tr>";
   ...
   <td><a href="SeeEvidenceTypeDetails.jsp?evidencetypeid=<%=evidencetypemodel.getEvidencetypeid()%>"><%=evidencetypemodel.getEvidencetypename() %> </a></td>
     
         <td><%=evidencetypemodel.getEvidencetypeabbr()%></td>
         <td><%=evidencetypemodel.getEvidencetypedesc()%></td> 
