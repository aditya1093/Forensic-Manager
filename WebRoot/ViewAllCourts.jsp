...
<table align="center" WIDTH="600" border="0" bordercolor="black" bgcolor="#F4F5F7">
    ...
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </span> 
      ...
      report+=" <th colspan='15' bgcolor='black'><center><b><font color='white'>COURTS DETAILS</font></center></th>";
     ...
     if(request.getParameter("status")!=null)
      ...
      report+="</center></td></tr><tr><td>Court Name </td><td>Court Type Name</td><td>Court Address</td><td>Phone No</td><td>E-Mail</td><td>Web Link</td></tr>";    
    ...
    <td>Court Name </td>
     ...
     <td>Web Link</td>      
         ...
         <% while(em.hasMoreElements()){
             ...
             report+="<tr><td value="+courtmodel.getCourtid()+">"+courtmodel.getCourtname()+"</td>";

         report+="<td  value="+courtmodel.getCourttypeid()+">"+courtmodel.getCourttypename()+"</td>"; 
         report+="<td>"+courtmodel.getCourtaddress()+"</td>";
         report+="<td>"+courtmodel.getCourtphno()+"</td>"; 
         report+="<td>"+courtmodel.getCourtemail()+"</td>";
         report+="<td>"+courtmodel.getCourtweblink()+"</td></tr>";
 ...
 %>
   ...
   <td><a href="SeeCourtDetails.jsp?courtid=<%=courtmodel.getCourtid()%>"><%=courtmodel.getCourtname() %> </a></td>
