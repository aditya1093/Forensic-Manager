 ...
 <tr>
    <td valign="top" bgcolor="#F4FFE4"><table width="100%" border="0">
      <tr>
        ...
        <form name="updatecourttype" action="./" method="post" onSubmit="return validate()" >     
...
<%--      --%>
      ...
      <td><input type="text" name="courttypedesc" value=""/>
      </td>
      </tr>
...
var frmvalidator  = new Validator("updatecourttype");
