...
function inDate(){
  ...
  var date=new Date();
  document.addclient.dateofreg.value=date.getDate()+"-"+(date.getMonth()+1)+"-"+date.getYear();
...
function goOn() {
var port=document.addclient.port.value;
var host=document.addclient.host.value;
var username=document.addclient.username.value;
window.location.href='http://'+host+':'+port+'/LegalManagementSystem/GetClientAction?username='+username;
...
function ValidatePnoneNumber(){
	...
	var Phone=document.addclient.phoneNo;
...
<table width="103%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
  ...
  <form name="addclient" action="./RegisterAction" method="post" onSubmit="return validate()" >     
<table border=1 bordercolor=red><tr><td><table align="center" WIDTH="850" border="0" bordercolor="black" bgcolor="#F4FFE4">
      
        <input type="hidden" name="port" value="<%=request.getLocalPort() %>"/>
 <input type="hidden" name="host" value="<%=request.getServerName() %>"/>
      
      <th colspan="6"><center><b><font color="blue">CLIENT DETAILS</font></center></th>
      <tr rowspan="5"></tr>
     <tr></tr><tr></tr>
     <tr><td><span class=Title><H4><strong><font color="red">
    <%if(request.getParameter("status")!=null)out.print(request.getParameter("status"));    %> </font></strong></H4></span> </td></tr>
     
     
      <tr><td><strong>First&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="firstname" value=""/></td>
      
     <td><strong>Mid&nbsp;Name&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="middlename" value=""/> </td>
      
      <td><strong>Last&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="lastname" value=""/>  </td> </tr>
      
     <tr>
     <td> <strong>Father&nbsp;First&nbsp;Name&nbsp;&nbsp;</strong><input type="text" name="cffirstname" value="<%request.getParameter("firstname"); %>"/></td>
      
     <td><strong> Father&nbsp;Mid&nbsp;Name&nbsp;&nbsp;</strong><input type="text" name="cfmiddlename" value="<%request.getParameter("midname"); %>"/></td>
      
    <td><strong>Father&nbsp;Last&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="lastname" value="<%request.getParameter("lastname"); %>"/> </td> </tr>
      
     
      <tr>
      <td width=500><strong>Client&nbsp;DOB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input type="text" name="dob" value="<%request.getParameter("clientdob"); %>"/> </td> 
<%--      --%>
<%--      --%>
...
<%--        </SELECT> </td>--%>
      ...
      <td width=500><strong>Father&nbsp;DOB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </strong>
    <SELECT name=fday size=1 > 
      ...
      <td><strong>Date&nbsp;Of&nbsp;Registration&nbsp;&nbsp;</strong><input type="text" name="dateofreg" onfocus="inDate()"/> </td>
      </tr>
      
      
       <tr><td><strong>
      User Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
      <select name="username" onblur="GoOn()">
      ...
      <td><strong>E-MailID</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="text" name="mailid" onBlur="checkMailId(addclient.mailid.value)"  value="<%request.getParameter("mailid"); %>"/> </td></tr>
      
  
  <tr></tr><tr></tr>
<th colspan="6"><center><span class=Title><font color="green">CONTACT DETAILS</font></span>
</center></th>
<tr></tr><tr></tr>
...
<tr>
    ...
    <option value="personal"><font size="3" face="Verdana">Personal</font></option>
	  ...
	  <td><strong>City</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="city" value="" size="20"/> </td>
</tr>
<tr>
    <td><strong>House No</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="houseNo" value="" size="20"/></td>
	
	  
	<td><strong>State</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="state" value="" size="20"/></td>
</tr>
<tr>
    <td><strong>Street</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="street" value="" size="20"/></td>
	
	<td><strong>Country</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="country" value="" size="20"/></td>
</tr>
<tr>
    <td><strong>Phone Type</strong>&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><strong>Pin</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pin" value="" size="20" />	</td>
	
</tr>
<tr>
    <td><strong>Phone No</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="phoneNo" onBlur="ValidatePnoneNumber()" value="" size="20" /></td>
    
	<td><strong>Land Mark</strong>&nbsp;&nbsp;<input type="text" name="landMark" value="" size="20" onblur="showStatus()"/></td>
</tr>
<th colspan="5">&nbsp;</th>
<tr></tr><tr></tr>
