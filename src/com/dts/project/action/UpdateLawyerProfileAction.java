...
public class UpdateLawyerProfileAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		  ...
		  boolean flag=false;
			...
			String target="SeeLawyerProfile.jsp?status=Update  Lawyer Details Is Invalid";
			try{
			...
			if(flag){ 
			   target = "SeeLawyerProfile.jsp?status=Update Lawyer Details  Successfully Done"; 
			   System.out.println(" after flag--->"+flag);
			}
			   else  
			    target = "SeeLawyerProfile.jsp?status=Update Lawyer Details Is Failed"; 
