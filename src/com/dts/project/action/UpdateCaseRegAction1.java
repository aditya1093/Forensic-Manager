...
public class UpdateCaseRegAction1 extends HttpServlet {
		...
		String ndate=nday+"-"+nmonth+"-"+nyear;
		 ...
		 String button=request.getParameter("submit");	
		  boolean flag=false;
			...
			String target="ViewAllCaseRegistration.jsp?status=Update  Case Registration Details Is Invalid";
			try{
			...
			if(flag) 
			   target = "ViewAllCaseRegistration.jsp?status=Update  Case Registration Details Successfully Done"; 
			else  
			    target = "ViewAllCaseRegistration.jsp?status=Update  Case Registration Details Is Failed"; 
